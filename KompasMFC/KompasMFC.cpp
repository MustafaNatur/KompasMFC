...
// KompasMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKompasMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKompasMFCApp

CKompasMFCApp::CKompasMFCApp()
{
...
// Единственный объект CKompasMFCApp

CKompasMFCApp theApp;


// Инициализация CKompasMFCApp

BOOL CKompasMFCApp::InitInstance()
{
